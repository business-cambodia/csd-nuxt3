<template>
  <div class="relative select-none">
    <div
      :class="`fixed flex justify-between px-4 xl:px-16 w-full items-center top-0 py-3 z-50 navbar ${
    ...
    >
      ...
      <div class="flex items-center space-x-4 font-poppins">
        <button
          ...
          class="flex items-center justify-between text-center border border-l-0 h-7 md:h-9 w-[70px] md:w-[90px] rounded-3xl"
          :class="
            scrollPosition == 0 ? 'text-white' : 'text-gray-800 border-gray-500'
          "
          type="button"
        >
          <div class="ml-[0.2px]">
